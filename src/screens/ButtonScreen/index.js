    ...
    <ScrollView style={styles.container}>
      <View style={styles.section}>
        ...
        <View style={styles.buttonGroup}>
            {buttons.map((item, key) => <SmallButton key={key} item={item} />)}
        </View>
      </View>
      <View style={styles.section}>
        <Text style={styles.title}>Default Sizes</Text>
        <View style={styles.buttonGroup}>
            {buttons.map((item, key) => <DefaultButton key={key} item={item} />)}
        </View>
      </View>
      <View style={styles.section}>
        <Text style={styles.title}>Large Sizes</Text>
        <View style={styles.buttonGroup}>
            {largeButtons.map((item, key) => <LargeButton key={key} item={item} />)}
        </View>
      </View>
      <View style={styles.section}>
        <Text style={styles.title}>Block Width</Text>
        {blockButtons.map((item, key) => <BlockWidthButton key={key} item={item} />)}
      </View>
      <View style={styles.section}>
        <Text style={styles.title}>Full Width</Text>
        {blockButtons.map((item, key) => <FullWidthButton key={key} item={item} />)}
      </View>
    </ScrollView>
  );
};
